function(build_cmake_format_target)
    ...
    list(FILTER CMAKE_FILES_TXT EXCLUDE REGEX
        "${CMAKE_SOURCE_DIR}/(out|external|tools|.github|vcpkg|SFML)/+"
    )
...
function(build_clang_format_target)
    ...
    list(FILTER CPP_FILES EXCLUDE REGEX
        "${CMAKE_SOURCE_DIR}/(out|external|vcpkg|SFML)/+"
    )
