...
private:
    ...
    size_t m_id{0};
    std::set<std::string> m_subscribed_topics;  // Cache of subscribed topics
...
protected:
    ...
    // Pub/Sub methods (accessible to derived classes)
    ...
    void draw_sprite(sf::RenderWindow& window) noexcept
    {
