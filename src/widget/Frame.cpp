...
namespace duyld
{
    Frame::Frame(Frame* parent, const sf::Vector2f& shape)
        : sf::RectangleShape(shape), needupdate(true), m_parent(parent), m_vertical_pad({0, 0}),
          m_horizontal_pad({0, 0}), m_vertical_gap(-1), m_horizontal_gap(-1), m_layout(Vertical),
          m_horizontal_resizing(Hug), m_vertical_resizing(Hug), m_vertical_alignment(LEFT),
          m_horizontal_alignment(MIDDLE)
    {}
